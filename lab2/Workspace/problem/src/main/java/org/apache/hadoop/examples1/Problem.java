...
public class Problem extends Configured implements Tool {
	...
	public static class Reduce extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
		...
		public void reduce(Text key, Iterator<Text> values,
			...
			if (key.toString().equals("924") || 
					key.toString().equals("8941") || 
					key.toString().equals("8942") || 
					key.toString().equals("9019") || 
					key.toString().equals("9020") || 
					key.toString().equals("9021") || 
					key.toString().equals("9022") || 
					key.toString().equals("9990") || 
					key.toString().equals("9992")|| 
					key.toString().equals("9993") ) {
